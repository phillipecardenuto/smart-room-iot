/**
   ...
   Step 2 : Start scan./.local/share/Trash/files/maestro/esp_now.hning for Slave ESP32 (we have added a prefix of `slave` to the SSID of slave for an easy setup)
